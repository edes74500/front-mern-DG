...
export function Header({ isUserMenuOpen, setIsUserMenuOpen }: HeaderProps) {
  ...
  return (
    <header
      className="relative z-20 py-4 text-gray-800 bg-white shadow-xl"
      onClick={() => {
        isUserMenuOpen ? setIsUserMenuOpen(false) : undefined;
      }}
    >
      {/* Overlay pour l'effet de flou ou d'atténuation */}
      {/* Conteneur du header */}
